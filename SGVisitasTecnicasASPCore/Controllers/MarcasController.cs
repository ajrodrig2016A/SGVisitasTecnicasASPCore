...
namespace SGVisitasTecnicasASPCore.Controllers
{
    ...
    public class MarcasController : Controller
    {
        ...
        public IActionResult Create(marcas item)
        {
            ...
            {
                TempData["SuccessMessage"] = "Marca " + item.nombre + " creada exitosamente";
        ...
        public IActionResult Edit(marcas item)
        {
            ...
            try
            {
                ...
                if (errMessage == "")
                {
                    ...
                    TempData["SuccessMessage"] = "Marca " + item.nombre + ", guardada exitosamente";
                    bolret = true;
                }
            }
            catch (Exception ex)
        ...
        public IActionResult Delete(int id, IFormCollection collection)
        {
            ...
            TempData["SuccessMessage"] = "Marca " + item.nombre + " borrada exitosamente";
            return RedirectToAction(nameof(Index), new { pg = currentPage });
